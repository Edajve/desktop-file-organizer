...
public class PathConstants {
    ...
    // Test constants
    public final static String UNIT_TEST_PATH = File.separator + "Users" + File.separator + "dajve.echols" + File.separator + "file-structure" +
            File.separator + "03-personal" + File.separator + "02-for-storage" + File.separator + "testing-directory-for-automatic-desktop-organizer";
