...
public class DirectoryPaths {
    ...
    public final static String DESKTOP_TEST_PATH = File.separator + "Users" + File.separator + "dajve.echols" + File.separator + "Desktop" + File.separator + "directory-for-testing";
}
